...
--------------------------------------------------------
   CREATE SEQUENCE  "CERT_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 84802 CACHE 20 NOORDER  NOCYCLE ;
   
--------------------------------------------------------
--  DDL for Sequence FILE_ID_SEQ
--------------------------------------------------------
   CREATE SEQUENCE  "FILE_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 87746 CACHE 20 NOORDER  NOCYCLE ;
...
--------------------------------------------------------
   CREATE SEQUENCE  "PRODUCT_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 882050 CACHE 20 NOORDER  NOCYCLE ;
   
--------------------------------------------------------
--  DDL for Table C_CERT
--------------------------------------------------------

  CREATE TABLE "C_CERT" ("CERT_ID" NUMBER, "FORMS" VARCHAR2(1000 BYTE), "UNN" VARCHAR2(1000 BYTE), "KONTRP" VARCHAR2(1000 BYTE), "KONTRS" VARCHAR2(1000 BYTE), "ADRESS" VARCHAR2(1000 BYTE), "POLUCHAT" VARCHAR2(1000 BYTE), "ADRESSPOL" VARCHAR2(1000 BYTE), "DATACERT" VARCHAR2(1000 BYTE), "NOMERCERT" VARCHAR2(1000 BYTE), "EXPERT" VARCHAR2(1000 BYTE), "NBLANKA" VARCHAR2(1000 BYTE), "RUKOVOD" VARCHAR2(1000 BYTE), "TRANSPORT" VARCHAR2(1000 BYTE), "MARSHRUT" VARCHAR2(1000 BYTE), "OTMETKA" VARCHAR2(1000 BYTE), "STRANAV" VARCHAR2(1000 BYTE), "STRANAPR" VARCHAR2(1000 BYTE), "STATUS" VARCHAR2(1000 BYTE), "KOLDOPLIST" VARCHAR2(1000 BYTE), "FLEXP" VARCHAR2(1000 BYTE), "UNNEXP" VARCHAR2(1000 BYTE), "EXPP" VARCHAR2(1000 BYTE), "EXPS" VARCHAR2(1000 BYTE), "EXPADRESS" VARCHAR2(1000 BYTE), "FLIMP" VARCHAR2(1000 BYTE), "IMPORTER" VARCHAR2(1000 BYTE), "ADRESSIMP" VARCHAR2(1000 BYTE), "FLSEZ" VARCHAR2(1000 BYTE), "SEZ" VARCHAR2(1000 BYTE), "FLSEZREZ" VARCHAR2(1000 BYTE), "STRANAP" VARCHAR2(1000 BYTE), "OTD_ID" NUMBER, "PARENTNUMBER" VARCHAR2(50 BYTE), "PARENTSTATUS" VARCHAR2(80 BYTE), "ISSUEDATE" DATE, "CODESTRANAV" VARCHAR2(4 BYTE), "CODESTRANAPR" VARCHAR2(4 BYTE), "CODESTRANAP" VARCHAR2(4 BYTE), "CATEGORY" VARCHAR2(20 BYTE)) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "C_OTD" ("ID" NUMBER, "NAME" VARCHAR2(255 BYTE), "NAME_SYN" VARCHAR2(100 BYTE), "ADDR_INDEX" VARCHAR2(250 BYTE), "ADDR_CITY" VARCHAR2(250 BYTE), "ADDR_LINE" VARCHAR2(250 BYTE), "ADDR_BUILDING" VARCHAR2(250 BYTE), "ADDR_OFFICE" VARCHAR2(250 BYTE), "WORK_PHONE" VARCHAR2(50 BYTE), "CELL_PHONE" VARCHAR2(50 BYTE)) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "PCH_PURCHASE" ADD CONSTRAINT "FK_ID_PRODUCT" FOREIGN KEY ("ID_PRODUCT") REFERENCES "PCH_PRODUCT" ("ID") ENABLE;
