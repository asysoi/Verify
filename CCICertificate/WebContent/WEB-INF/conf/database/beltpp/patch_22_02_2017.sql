...
DROP TABLE FS_BRANCH_DENORM;
DROP TABLE FS_PRODUCT_DENORM;
...
--------------------------------------------------------
  ...
  CREATE TABLE "FS_PRODUCT_DENORM" 
   ("ID_FSCERT" NUMBER, 
	"TOVARS" CLOB
   );
