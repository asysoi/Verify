		...
		$("document").ready(
				function() {
					$(".datepicker").datepicker("option", "dateFormat",
							'dd/mm/yy');
					$("#pchdate").datepicker("setDate",
							"${purchase.pchdate}");
					$("#product")
							.val('${purchase.id_product}');
					$("#department")
							.val('${purchase.id_otd}');
...
<form:form id="fitem" method="POST" commandName="purchase">
	...
	<table class="filter">
			...
			<tr>
				...
				<td><form:input path="productproperty" id="productproperty"  size="35" /><a
			...
			<tr>
				<td>Дата сделки</td>
				<td><form:input path="pchdate" id="pchdate"
						class="datepicker" size="10" />&nbsp;-&nbsp; 
						<a	href="javascript:clearelement($('.datepicker'));"> <img
						src="resources/images/delete-16.png" alt="удл." />
				</a></td>
			</tr>
	</table>
